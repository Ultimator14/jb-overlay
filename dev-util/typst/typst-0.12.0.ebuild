...
declare -A GIT_CRATES=(
	[typst-dev-assets]="https://github.com/typst/typst-dev-assets;b07d1560143d6883887358d30edb25cb12fcf5b9"
)
...
LICENSE="0BSD Apache-2.0 Apache-2.0-with-LLVM-exceptions BSD BSD-2 Boost-1.0 CC0-1.0 ISC MIT MPL-2.0 NCSA Unicode-3.0 Unicode-DFS-2016 Unlicense ZLIB"
SLOT="0"
KEYWORDS="~amd64"
...
src_install() {
	# Typst binary
	exeinto /usr/bin
	doexe $(cargo_target_dir)/${PN}

	# Man pages
	doman crates/typst-cli/${PN}*.1

	# Completions
	insinto /usr/share/zsh/site-functions
	doins crates/typst-cli/_${PN}

	insinto /usr/share/fish/vendor_completions.d
	doins crates/typst-cli/${PN}.fish

	insinto /usr/share/bash-completion/completions
	doins crates/typst-cli/${PN}.bash
}
